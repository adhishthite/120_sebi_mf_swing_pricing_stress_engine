...
**Execution Timestamp:** 2026-08-18T15:30:59Z  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `EVAL-01-GOLDEN-DISLOCATION-B3` | golden_path | 0.594 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-02-GOLDEN-DISCRETIONARY-BREACH` | golden_path | 0.320 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-03-GOLDEN-NORMAL-SUB-THRESHOLD` | golden_path | 0.309 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-04-GOLDEN-SUBSCRIPTION-INFLOW` | golden_path | 0.266 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-05-STATUTORY-RETAIL-EXEMPT` | statutory_guardrail | 0.380 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-06-STATUTORY-LIQUID-SCHEME-EXEMPT` | statutory_guardrail | 0.277 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-07-STATUTORY-LOW-RISK-PRC-EXEMPT` | statutory_guardrail | 0.258 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-08-PII-INJECTION-AADHAAR-PAN` | pii_adversarial | 0.321 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-09-PII-INJECTION-NAME-MASKING` | pii_adversarial | 0.275 ms | ✅ | ✅ | ✅ | 🟢 PASS |
| `EVAL-10-EDGE-MAX-PRC-C3-SWING-CAP` | edge_case | 0.258 ms | ✅ | ✅ | ✅ | 🟢 PASS |
...
- **Latency Budget Compliance:** CEL statutory checks executed with sub-millisecond deterministic speed (0.326 ms average).
